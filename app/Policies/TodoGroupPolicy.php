...
class TodoGroupPolicy
{
    ...
    {
        return $user->id === $todoGroup->user_id;
    }
     ...
     */
    public function restore(User $user, TodoGroup $todoGroup): bool
    {
        return $user->id === $todoGroup->user_id;
    }
     ...
     */
    public function forceDelete(User $user, TodoGroup $todoGroup): bool
    {
        return $user->id === $todoGroup->user_id;
    }
}